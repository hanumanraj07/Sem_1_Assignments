let move_speed = 1.8, grativy = 0.15;
let bird = document.querySelector('.bird');
let img = document.getElementById('bird-1');
let sound_point = new Audio('sounds effect/point.mp3');
let sound_die = new Audio('sounds effect/die.mp3');

// Load highest score from localStorage (if any)
...
function play(){
                   ...
                   bird_props.top + bird_props.height > pipe_sprite_props.top){
                    ...
                    if(pipe_sprite_props.right < bird_props.left &&
                       ...
                       element.increase_score == '1'){
                        ...
                        sound_point.play();
                        element.increase_score = '0'; // prevent double counting
    ...
    function apply_gravity(){
        ...
        document.addEventListener('keydown', (e) => {
            if(e.key == 'ArrowUp' || e.key == ' '){
                img.src = 'https://res.cloudinary.com/dsvggz83x/image/upload/v1759425848/Bird-2_eio0dp.png';
                bird_dy = -5.6;
            }
        });
        ...
        document.addEventListener('keyup', (e) => {
            if(e.key == 'ArrowUp' || e.key == ' '){
                img.src = 'https://res.cloudinary.com/dsvggz83x/image/upload/v1759425848/Bird_savzt5.png';
            }
        });
    ...
    function create_pipe(){
        ...
        if(pipe_seperation > 180){
            ...
            let pipe_posi = Math.floor(Math.random() * 43) + 4;
